...
from tickets.views import WelcomeView, MenuView, ChangeOilView, InflateTiresView, DiagnosticView, ProcessingView, \
    NextView
...
urlpatterns = [
    ...
    path('processing/', RedirectView.as_view(url='/processing')),  # fail-safe
    path('next/', NextView.as_view()),  # fail-safe
]
