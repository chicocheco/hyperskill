...
class TicTacToe:
    ...
    def menu(self):
        possible_args = ('user', 'easy', 'medium')
        while True:
    ...
    def is_finished(self):
        for direction in (self.horizontal, self.vertical, self.primary_diagonal, self.secondary_diagonal):
            if direction():  # check for X or O in a row
                return True
